const GEMINI_API_KEY = import.meta.env.VITE_GEMINI_API_KEY || 'AIzaSyCkuecpnCTRK3F39fKdIkqcq-v3qcDl1Uo'
...
export async function callGemini(prompt: string): Promise<GeminiResponse> {
  console.log('🔍 Calling Gemini API for business guidance:', prompt)
